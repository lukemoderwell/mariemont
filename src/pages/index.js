    ...
    <div className={styles.dashboard}>
      ...
      <div className={styles.main}>
        <div className={styles.totals}>
          <div className={styles.stat}>
            ...
            <p className={styles.change}>
              {current.total - previous.total} / last week
            </p>
          </div>
          <div className={styles.stat}>
            <p>Facebook</p>
            <span className={styles.count}>{current.Facebook}</span>
            <p className={styles.change}>
              {current.Facebook - previous.Facebook} / last week
            </p>
          </div>
          <div className={styles.stat}>
            <p>YouTube</p>
            <span className={styles.count}>{current.YouTube}</span>
            <p className={styles.change}>
              {current.YouTube - previous.YouTube} / last week
            </p>
          </div>
          <div className={styles.stat}>
            <p>Website</p>
            <span className={styles.count}>{current.Website}</span>
            <p className={styles.change}>
              {current.Website - previous.Website} / last week
            </p>
          </div>
        </div>
        <div className={styles.summary}>
          ...
          <p>
            There were <strong>{current.total} views</strong> for{' '}
